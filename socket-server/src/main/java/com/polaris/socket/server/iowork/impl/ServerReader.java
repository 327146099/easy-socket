...
import com.polaris.socket.server.ServerConfig;
import com.polaris.socket.core.message.base.OriginReadData;
...
public class ServerReader implements IReader {
    ...
    public ServerReader(InputStream inputStream, ISocket socket, HandlerIO handlerIO) {
