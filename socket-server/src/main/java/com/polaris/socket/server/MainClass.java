...
import com.polaris.socket.server.iowork.impl.ServerIOManager;
...
//    private ServerSocket server9998 = null;
    ...
    static class Service implements Runnable {
        ...
        @Override
        public void run() {
            serverIoManager = new ServerIOManager(new NetworkSocket(socket));
            serverIoManager.setIdeaTimeout(15 * 1000);
